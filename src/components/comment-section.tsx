...
export function CommentSection({
    ...
    return (
        <div className="mt-12 pt-8 border-t border-amber-100 max-w-2xl mx-auto w-full">
            <h3 className="text-xl font-bold flex items-center gap-2 text-zinc-800 mb-8">
                <MessageCircle className="text-amber-500" size={24} />
                评论区 ({initialComments.length})
            </h3>

            {/* 发表留言框 */}
            <div className="bg-[#fffef9] p-5 rounded-2xl border border-amber-100 shadow-sm mb-10">
